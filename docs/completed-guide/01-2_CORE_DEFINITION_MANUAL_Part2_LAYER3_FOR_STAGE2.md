# ⚠️ 참고용 - Layer 3 내용 (Stage 2 작성 시 활용)

> **⚠️ 이 파일은 보존용입니다**
>
> **목적**: 02_STRUCTURE_DESIGN_MANUAL 작성 시 Layer 3 내용 활용
>
> **작업 내역**:
> - 2025-11-12: Stage 구조 재정립
> - Layer 3가 Stage 1 → Stage 2로 이동
> - 이 파일의 544줄 이후 내용을 Stage 2 Manual에 통합 예정
>
> **원본**: 01-2_CORE_DEFINITION_MANUAL_Part2.md (원래 버전)
>
> ---
>
> **아래는 원본 내용입니다 (참고용)**
...
# 핵심정의 해설서 Part 2: NFR 우선순위와 환경 제약 (원본)

> **목적**: 핵심정의 가이드의 상세 해설 - Layer 2와 Layer 3
>
> **참고**:
...
2. [Layer 3: 환경 제약사항](#2-layer-3-환경-제약사항)
...
> **오늘 발견** (2025-11-12): Phase 2 주식 거래 플랫폼 분석
...
### 2.3 L3-Q2: 보안/컴플라이언스 상세

#### 개인 개발자 vs 서비스 제공자 구분 ⭐

> **오늘 발견** (2025-11-12): Jason의 중요한 지적
