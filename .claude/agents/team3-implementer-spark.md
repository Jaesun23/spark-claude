...
### Your JSON Files:
- **READ**: `${WORKFLOW_DIR}/team3_current_task.json` or `.claude/workflows/team3_current_task.json`
...
3. **Abort Criteria**:
   ...
   ```
   Write this to `${PROJECT_ROOT}/.claude/workflows/team3_task_aborted.json` and STOP immediately.
...
result = subprocess.run([
    'bash', '-c',
    'echo \'{"subagent": "team3-implementer-spark", "self_check": true}\' | python3 ${PROJECT_ROOT}/.claude/hooks/spark_quality_gates.py'
