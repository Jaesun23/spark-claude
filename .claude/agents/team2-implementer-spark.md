...
description: Team 2 implementation specialist for multi-team parallel execution. Reads and writes team2_current_task.json (initialized from .claude/workflows/team_current_task_template.json) to track implementation progress and quality metrics.
