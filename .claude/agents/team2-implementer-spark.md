...
### Your JSON Files:
- **READ**: `${WORKFLOW_DIR}/team2_current_task.json` or `.claude/workflows/team2_current_task.json`
...
3. **Abort Criteria**:
   ...
   ```
   Write this to `${PROJECT_ROOT}/.claude/workflows/team2_task_aborted.json` and STOP immediately.
...
# Agent-specific metrics for team2-implementer-spark
...
task_data["quality"] = {
    ...
    "step_6_testing": {
        "coverage": -1  # Team2-implementer doesn't do testing
    },
...
result = subprocess.run([
    'bash', '-c',
    'echo \'{"subagent": "team2-implementer-spark", "self_check": true}\' | python3 ${PROJECT_ROOT}/.claude/hooks/spark_quality_gates.py'
...
if "Quality gates PASSED" in result.stdout:
    ...
    print("Agent: team2-implementer-spark")
